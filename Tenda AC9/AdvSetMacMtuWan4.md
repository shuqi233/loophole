...
In Tenda ac9 v1.0 routers with firmware version V15.03.05.14_multi, the mac parameter of route /goform/AdvSetMacMtuWan has a stack overflow vulnerability, which can lead to remote arbitrary code execution.
