...
In Tenda ac21 V1.0 routers with firmware version V16.03.08.16, the time parameter of route /goform/SetSysTimeCfg has a stack overflow vulnerability, which can lead to remote arbitrary code execution.
...
![img](./img/fromSetSysTime-time.png)
